    ...
    public void createFrame(){
        ...
        updateBtn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                int rowIndex = table.getSelectedRow();
                if (rowIndex == -1){
                    JOptionPane.showMessageDialog(MainView.this,"请先选中要修改的同学","提示",JOptionPane.WARNING_MESSAGE);
                }else{
                    int id = ((Integer)table.getModel().getValueAt(rowIndex,0)).intValue();
                    UpdateView updateView = new UpdateView(MainView.this,id);
                    updateView.createFrame();
                }
            }
        });
